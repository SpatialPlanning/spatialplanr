...
We first assume that we have two zones of interest that have the same set of features, but separate cost layers. For this, we need to set targets for both zones, in our case 20% for all features in the first zone and 5% of all features in the second zone.
...
-   [Bonnevie et al. 2019](https://doi.org/10.1016/j.marpol.2019.103533): "multi-use is a specific co-location/coexistence where resources are being shared."
