...
```{r plot-tas-data, fig.width=8, fig.height=6, out.width="100%"}
# Plot
...
-   Running Cohon calibration on the full dataset (100%) is prohibitively slow, so it would be worth re-running at 100% on a more powerful machine.
...
```{r base-solution, fig.width=8, fig.height=6, out.width="100%"}
...
```{r manual-bp-plot-low, fig.width=8, fig.height=6, out.width="100%"}
plot_prioritizr(bp_low_solution)
```

```{r manual-bp-plot-high, fig.width=8, fig.height=6, out.width="100%"}
...
```{r plot cohon-calibrated, fig.width=8, fig.height=6, out.width="100%"}
...
cohon_metrics <- summarise_solution(
  ...
  min_patch_size   = NULL,
  boundary_penalty = as.numeric(cohon_penalty)  # 👈 use the calibrated value here
)
...
```{r plot Min-patch, fig.width=8, fig.height=6, out.width="100%"}
...
```{r minpatch-map-compare, fig.width=8, fig.height=6, out.width="100%"}
...
```{r all-maps-patchwork, fig.width = 15, fig.height = 10, out.width="100%"}
